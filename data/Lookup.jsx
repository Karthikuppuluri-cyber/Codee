...
export default {
  ...
  INPUT_PLACEHOLDER: 'Build anything with Codiee',
  SIGNIN_HEADING: 'Continue With Codiee',
  SIGNIN_SUBHEADING: 'To use Codiee you must log into an existing account or create one.',
